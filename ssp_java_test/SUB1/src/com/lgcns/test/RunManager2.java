...
public class RunManager2 {
	...
	public static void main(String[] args) throws Exception {
		//1. 파일 라인 단위로 읽어 라인별 객체화 하기 => 라인단위로 읽어서 FileLineObject클래스로 1. 객체list 혹은 2. String 
		objList = getObjectListByFileLineWithStream(InputFilePath, FileLineObject.class);
		stringObjList = getLineListByFileLineWithStream(InputFilePath); //String으로 받을꺼면 이렇게
